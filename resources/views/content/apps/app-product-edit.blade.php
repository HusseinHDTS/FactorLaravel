...
@section('content')
    ...
    <div class="app-ecommerce">
        <!-- Add Product Form -->
        <form action="/app/product/edit/{{ $product->id }}" method="POST" id="productForm">
            @csrf
            <div class="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center mb-3">
                <div class="d-flex flex-column justify-content-center">
                    <h4 class="mb-1 mt-3">یک طرح موجود را ویرایش کنید</h4>
                    <p class="text-muted">طرح‌هایی که ساخته میشود در قسمت ایجاد فاکتور قابل انتخاب و نمایش هستند</p>
                </div>
                <div class="d-flex align-content-center flex-wrap gap-3">
                    <div class="d-flex gap-3">
                    </div>
                    <button class="btn btn-primary" type="submit">ویرایش طرح</button>
                </div>
            </div>
            <div class="row">
                <!-- First column-->
                        ...
                        <div class="card-body">
                            <div class="mb-3">
                                ...
                                <input aria-label="عنوان طرح" class="form-control" id="ecommerce-product-name"
                                    name="name" placeholder="عنوان طرح" type="text" value="{{ $product->name }}"
                                    required />
                            </div>
                            <div class="row mb-3">
                                <div class="col">
                                    ...
                                    <input aria-label="طرح SKU" class="form-control" id="ecommerce-product-sku"
                                        name="sku" placeholder="SKU" type="text" value="{{ $product->sku ?? '' }}" />
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="form-repeater">
                                <div data-repeater-list="items">
                                    @if (is_array($product->items))
                                        @foreach ($product->items as $index => $productx)
                                            <div data-repeater-item>
                                                <div class="row">
                                                    ...
                                                    <div class="mb-3 col-4">
                                                        <input class="form-control" id="form-repeater-1-2"
                                                            placeholder="اندازه" type="text" name="sizes"
                                                            value="{{ $productx['sizes'] }}" />
                                                    </div>
                                                    <div class="mb-3 col-8">
                                                        <input class="form-control price-input" id="form-repeater-1-1"
                                                            placeholder="قیمت" type="tel" dir="rtl" name="prices"
                                                            value="{{ $productx['prices'] }}" />
                                                    </div>
                                                </div>
                                            </div>
                                        @endforeach
                                ...
                                <div>
                                    <button class="btn btn-primary" type="button" data-repeater-create>افزودن
                                        اندازه</button>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            ...
                            <div class="mb-3 col ecommerce-select2-dropdown">
                                ...
                                <select class="select2 form-select" data-placeholder="انتخاب محصول" name="category"
                                ...
                                <script>
                                    document.addEventListener('DOMContentLoaded', (event) => {
                                        ...
                                        var valueToSelect = '{{$product->category}}';

...
@section('content')
    <div class="invoice-print p-5">
        ...
        <div class="d-flex justify-content-between flex-row">
            ...
            <div>
                <h4 class="fw-medium">فاکتور #{{ $invoice->id }}</h4>
                <div class="mb-2">
            ...
            <table class="table m-0">
                ...
                <tbody>
                    ...
                    <tr>
                        <td></td>
                        <td></td>
                        <td class="ps-4 pe-0 text-start p-0">
        ...
        <div class="row">
            <div class="col-12">
                <span class="fw-medium">توضیحات فروشنده:</span>
                <span>
                    این توضیحات قابل تغییر و ثابت است
                </span>
            </div>
        </div>

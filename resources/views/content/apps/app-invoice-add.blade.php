...
@section('page-script')
    @vite(['resources/assets/js/app-invoice-add.js'])
                ...
                <div class="card-body">
                    <div class="row m-sm-4 m-0">
                        <div class="col-md-7 mb-md-0 mb-4 ps-0">
                            ...
                            <h5 class="mb-2">ثبت کننده سفارش : {{ Auth::user()->name }}</h5>
                            <p class="mb-3">
                        ...
                        <div class="col-md-5">
                            <dl class="row mb-2">
                                ...
                                <dd class="col-sm-6 d-flex justify-content-md-end pe-0 ps-0 ps-sm-2">
                                    <input type="text" name="recipt_date" class="form-control w-px-150 today-date"
                                        disabled />
                                </dd>
                            </dl>
                        </div>
                        ...
                        <div class="bs-stepper wizard-icons wizard-icons-invoice mt-2">
                            <div class="bs-stepper-header">
                                ...
                                <div class="step" data-target="#payment-info">
                                    <button class="step-trigger" type="button" disabled>
                                        <span class="bs-stepper-icon">
                                            <svg viewBox="0 0 58 54">
                                                <use
                            ...
                            <div class="bs-stepper-content">
                                <form onSubmit="return false">
                                    ...
                                    <div class="content" id="account-details">
                                        ...
                                        <div class="row">
                                            <input id="onwer_id" type="text" value="{{ Auth::user()->id }}" hidden>
                                            <div class="col-md-12 mb-md-0 mb-3">
                                                ...
                                                <div class="row g-3 mb-3">
                                                    <p class="mb-1">آدرس مشتری :</p>
                                                    <div class="col-12 mt-0">
                                                        <textarea class="form-control" id="customer_address" name="customer_address" placeholder="آدرس ..."></textarea>
                                                    </div>
                                                </div>
                                        ...
                                        <div id="productSelectionContainer">
                                            <div class="row product-selection p-1 mb-4 border border-2">
                                                ...
                                                <div class="col-12 px-4">
                                                    ...
                                                    @php
                                                        $productsList = ['Roofarshi', 'Farshine', 'Padari', 'Koosan', 'CoverToshak', 'CoverZedAb', 'ZirSofre', 'RooTakhti', 'ZirPayeMobli', 'ChasbRisheFarsh'];
                                                    @endphp
                                                    <div class="product-details-container">
                                                        <div>
                                                            {{-- {{ $pt }} --}}
                                                            <p class="mb-2">انتخاب طرح:</p>
                                                            <select class="mb-4 form-control design-picker info-picker"
                                                                name="productDesign">
                                                                <option value="" selected>انتخاب کنید ...</option>
                                                                @isset($productTypes['Roofarshi'])
                                                                    @foreach ($productTypes['Roofarshi'] as $pt)
                                    ...
                                    <div class="content" id="review-submit">
                                        ...
                                        <ul class="list-unstyled fw-normal">
                                            ...
                                            <p class="fw-bold mb-0">آدرس مشتری:</p>
                                            <li id="final-customer-address" class="mb-2"></li>
